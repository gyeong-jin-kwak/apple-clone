  ...
  const sceneInfo = [
    {
      ...
      values: {
        videoImageCount: 300,
        imageSequence:[0, 299],
        canvas_opacticy:[1, 0, { start: 0.9, end: 1 }],
    ...
    },
    {
      ...
      values: {
          videoImageCount: 960,
          imageSequence:[0, 959],
          canvas_opacticy_in:[0, 1, { start: 0, end: 0.1 }],
          canvas_opacticy_out:[1, 0, { start: 0.95, end: 1 }],
  ...
  function playAnimation() {
    ...
    switch(currentScene) {
      case 0:
        ...
        objs.canvas.style.opacity = calcValues(values.canvas_opacticy, currentYOffset);
      ...
      case 2:
        ...
        if (scrollRatio <= 0.5) {
          // in
          objs.canvas.style.opacity = calcValues(values.canvas_opacticy_in, currentYOffset);
        } else {
          // out
          objs.canvas.style.opacity = calcValues(values.canvas_opacticy_out, currentYOffset);
        }
        ...
        if(scrollRatio > 0.9) {
          ...
          if(widthRatio <= heightRatio) {
            // canvas 보다 브라우저 창이 좁을 경우
            canvasScaleRatio = heightRatio;
          } else {
            // canvas 보다 브라우저 창이 납작할 경우
